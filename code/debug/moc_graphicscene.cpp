...
**
** Created: Fri Aug 21 16:19:50 2009
...
static const uint qt_meta_data_GraphicScene[] = {
...
static const char qt_meta_stringdata_GraphicScene[] = {
    "GraphicScene\0\0item\0itemInserted(Component*)\0"
    "itemSelected(QGraphicsItem*)\0mode\0"
    "setMode(Mode)\0addItem(QGraphicsItem*)\0"
};

const QMetaObject GraphicScene::staticMetaObject = {
    { &QGraphicsScene::staticMetaObject, qt_meta_stringdata_GraphicScene,
      qt_meta_data_GraphicScene, 0 }
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_GraphicScene))
        return static_cast<void*>(const_cast< GraphicScene*>(this));
...
// SIGNAL 0
void GraphicScene::itemInserted(Component * _t1)
{
...
// SIGNAL 1
void GraphicScene::itemSelected(QGraphicsItem * _t1)
{
    void *_a[] = { 0, const_cast<void*>(reinterpret_cast<const void*>(&_t1)) };
